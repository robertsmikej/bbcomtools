...
<style>
    ...
    *:after {
    ...
    .element__bar__section--header__container {
        width: 100%;
        display: flex;
        flex-direction: column;
        align-content: center;
    ...
    .element__bar__section--header--img {
        max-width: 40px;
        margin: 0 auto 6px;
        display: block;
    }
    .element__bar__section--content__container {
        transition: all .3s;
        flex-direction: row;
        display: flex;
        flex-wrap: wrap;
